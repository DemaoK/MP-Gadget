...
{
#ifdef SIDM
    BHP(child).SIDMSeedOrigin = 0;
    BHP(child).SIDMSeedTrigger = SIDM_BHSEED_TRIGGER_NONE;
    BHP(child).SIDMSMFPMassInitial = 0;
    BHP(child).SIDMSMFPRadius = 0;
    BHP(child).SIDMDarkReservoirMass = 0;
    BHP(child).SIDMDarkReservoirInitial = 0;
    BHP(child).SIDMDarkMdot = 0;
    BHP(child).SIDMRhoInf = 0;
    BHP(child).SIDMSoundSpeedInf = 0;
    BHP(child).SIDMReservoirRadius = 0;
    BHP(child).SIDMGasDynMassDebt = 0;
