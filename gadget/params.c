...
create_gadget_parameter_set()
{
    ...
    param_declare_double(ps, "ActivePartFracForNewDomainDecomp", OPTIONAL, 0, "If > 0, extra non-PM domain decompositions are skipped when the current active particle fraction is below this threshold; PM steps still decompose.");
