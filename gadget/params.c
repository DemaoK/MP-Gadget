...
create_gadget_parameter_set()
{
    ...
    param_declare_double(ps, "SIDMBHMinFoFMass", OPTIONAL, 1e-2, "Minimum FoF Type 1 DM halo mass for SIDM BH seeding in internal mass units.");
    param_declare_double(ps, "SIDMBHCollapseThreshold", OPTIONAL, 2.0, "Integrated t/t_c threshold for SIDM BH seeding.");
    ...
    param_declare_double(ps, "MaxWindFreeTravelTime", OPTIONAL, 60, "Maximum time in Myrs/h for the wind to be decoupled.");
